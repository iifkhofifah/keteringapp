...
public class ValueAqiqahActivity extends AppCompatActivity {
    ...
    TextView Vnama,Vnohp,Valamat,Vspaqiqah,Vtanggal,Vharga;
...
//    private NotificationReceiver mReceiver = new NotificationReceiver();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Vharga = findViewById(R.id.vhartot);
        ...
        String vharga = valueveg.getStringExtra("extraHarga");
...
//                sendNotification();
    ...
    private void getpesaqiqah(){
        ...
        String Spinneraqiqah = Vspaqiqah.getText().toString().trim();
        String Tanggal = Vtanggal.getText().toString().trim();
        int Harga = Integer.parseInt(Vharga.getText().toString().trim());

        if(!TextUtils.isEmpty(Nama)){

            String id = databasegetpesaqiqah.push().getKey();

            getpesaqiqah pesaqiqah = new getpesaqiqah(id,Nama,Nohp,Alamat,Spinneraqiqah,Tanggal,Harga);
